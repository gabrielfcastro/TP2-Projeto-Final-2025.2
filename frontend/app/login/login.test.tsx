...
describe('Login Component', () => {
  test('Test 1: Render login form', () => {
    ...
    expect(screen.getByPlaceholderText('Digite sua senha (leia a descrição)')).toBeInTheDocument()
  ...
  test('Test 5: Validate invalid email', async () => {
    ...
    const passwordInput = screen.getByPlaceholderText('Digite sua senha (leia a descrição)')
