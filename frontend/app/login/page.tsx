...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (showRegister) {
      ...
      if (
        userType === "vendor" &&
        (!formData.nomeBanca || !formData.localizacao)
      ) {
    ...
    try {
        ...
        ? {
            ...
            tipo_usuario:
              userType === "vendor"
                ...
                : userType === "admin"
                  ? "Admin"
                  : "Usuario", // Capitalizado conforme padrão backend
          }
        : {
            email: formData.email,
      ...
      if (!contentType || !contentType.includes("application/json")) {
        throw new Error(
          `Resposta não é JSON. Status: ${response.status} ${response.statusText}`,
        );
      }
      ...
      if (showRegister) {
        ...
        alert(
          `Cadastro realizado como ${userType === "vendor" ? "Feirante" : userType === "admin" ? "Administrador" : "Usuário"}!`,
        );
        ...
        // Buscar dados completos do usuário (incluindo tipo_usuario)
        try {
          ...
          if (userResponse.ok) {
            ...
            if (Array.isArray(usuarios) && usuarios.length > 0) {
              ...
              if (usuarioLogado) {
                tipoUsuario = usuarioLogado.tipo_usuario;
              }
            }
          }
          ...
          // Se falhar ao buscar tipo, redireciona para página inicial
      ...
      setErrors([
        error instanceof Error
          ? error.message
          : "Erro ao conectar com o servidor. Verifique se o backend está rodando na porta 5000.",
      ]);
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 p-3 bg-zinc-800/30 rounded-lg border border-zinc-700/50">
            ...
            <p className="text-zinc-400 text-xs">
              ...
              1 numérico e 1 caractere especial e conter entre 8 à 15
              caracteres.
            </p>
