			...
			<div className="p-4 flex flex-col flex-1">
				...
				<div className="flex gap-2 mt-auto">
					<button
						...
						className="flex items-center justify-center gap-2 flex-1 px-4 py-2 rounded-lg font-medium transition-opacity hover:opacity-90"
						style={{
					...
					<button
						...
						className="px-4 py-2 rounded-lg font-medium transition-opacity hover:opacity-90 flex items-center justify-center"
						style={{
							backgroundColor: "#25D366",
							color: "#FFFFFF",
						}}
						title="Falar com Feirante"
					>
						<svg
							width="20"
							height="20"
